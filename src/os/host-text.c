                        ...
                        if (type == RXT_BLOCK){
                            ...
                            if (len > 1){
                                ...
                                if (
                                    ...
                                    caret.x = 1 + pos.sri.index;
                                    caret.y = 1 + elem.sri.index;
                                    pcaret = &caret;
                                }
                            }
                        }
                        ...
                        if (type == RXT_BLOCK){
                            ...
                            if (len > 1){
                                ...
                                if (
                                    ...
                                    highlightStart.x = 1 + pos.sri.index;
                                    highlightStart.y = 1 + elem.sri.index;
                        ...
                        if (type == RXT_BLOCK){
                            ...
                            if (len > 1){
                                ...
                                if (
                                    ...
                                    highlightEnd.x = 1 + pos.sri.index;
                                    highlightEnd.y = 1 + elem.sri.index;
                                }
                            }
                        }
                        break;
    ...
    case CMD_TEXT_FONT:
        {
            ...
            while ((type = RL_GET_FIELD(obj, w[0], &val)))
            {
                ...
                switch(RL_FIND_WORD(text_ext_words,w[0]))
                {
                    case W_TEXT_NAME:
                        if (type == RXT_STRING){
                            font->name_free = As_OS_Str(val.sri.series, &(font->name));
                        }
                        break;
