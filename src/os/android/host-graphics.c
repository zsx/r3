...
JNI_FUNC(void, WindowView_updateRootGob, jint w, jint h)
{
	Gob_Root->size.x = (REBD32)w;
	Gob_Root->size.y = (REBD32)h;
}
...
***********************************************************************/
{
	return (*jni_env)->CallFloatMethod(jni_env, jni_obj, jni_getSystemMetric, type);
}
