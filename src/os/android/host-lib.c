...
************************************************************************
**
**  Title: Android OS API function library called by REBOL interpreter
...
***********************************************************************/
{
	...
	if (jni_env == NULL) return;

	jstr = (*jni_env)->NewStringUTF(jni_env, url);
	
	(*jni_env)->CallVoidMethod(jni_env, jni_obj, jni_browseURL, jstr);
