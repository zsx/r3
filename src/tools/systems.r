...
systems: [
	...
	; no successful amiga builds reported since 5-Mar-2011
	[0.1.03 "amiga"         posix   [HID NPS +SC CMT COP -SP -LM]]

	; osx powerpc: no shared lib possible
	[0.2.04 "osx"           osx     [+OS NCM -LM]]
	; osx intel: shared libs possible
	...
	[0.4.30 "linux_mips"    linux   [+O2 HID LDL ST1 -LM]] ; glibc without C++
