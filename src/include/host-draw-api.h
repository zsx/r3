...
extern void rebdrw_gob_color(REBGOB *gob, REBYTE* buf, REBXYI abs_oft, REBXYI clip_ft, REBXYI clip_siz);
extern void rebdrw_gob_draw(REBGOB *gob, REBYTE* buf, REBXYI abs_oft, REBXYI clip_oft, REBXYI clip_siz);
extern void rebdrw_gob_image(REBGOB *gob, REBYTE* buf, REBXYI abs_oft, REBXYI clip_oft, REBXYI clip_siz);
