...
namespace agg
{
	...
	class agg_effects
    {
		...
		void get_offset(REBXYI* p);
		void get_size(REBXYI* p);
		...
		void fx_crop(REBXYI* p1, REBXYI* p2, unsigned char *src = 0, int src_w = 0, int src_h = 0);
		...
		void fx_extend(REBXYI* p1, REBXYI* p2, unsigned char *src = 0, int src_w = 0, int src_h = 0);
		void fx_fit(REBINT filter, REBINT mode, REBDEC blur, unsigned char *src, int src_w, int src_h, REBINT aspect = 0);
		void fx_flip(REBXYI* p, unsigned char *src = 0, int src_w = 0, int src_h = 0);
		void fx_gradcol(REBXYI* p, REBYTE* color1, REBYTE* color2, unsigned char *src = 0, int src_w = 0, int src_h = 0);
		void fx_gradient(REBXYI* p, REBYTE* color1, REBYTE* color2,unsigned char *src = 0, int src_w = 0, int src_h = 0, unsigned char *dst = 0, int dst_w = 0, int dst_h = 0);
		void fx_gradmul(REBXYI* p, REBYTE* color1, REBYTE* color2, unsigned char *src = 0, int src_w = 0, int src_h = 0);
		...
		void fx_reflect(REBXYI* p, unsigned char *src = 0, int src_w = 0, int src_h = 0);
		void fx_rotate(REBINT ang, unsigned char *src = 0, int src_w = 0, int src_h = 0);
		void fx_shadow(unsigned char *src, int src_w, int src_h, REBXYI* p1, REBXYI* p2, REBYTE* color, REBDEC blur, REBINT only);
